...
public class Tiles_Utility {
    ...
    /// </summary>
    public static string Last_Opened_Dir { get { return last_dir; } set { last_dir = value; } }
    ...
    public static string Final_image_folder_path
    {
        get
        {
            String tmp = Path.Combine("Assets", "RPG_Maker_Tiles_Importer", "_rtp_import");
            return tmp;
        }
    }
    ...
    public static string Auto_Tile_Folder_Path
    {
        get
        {
            String tmp = Path.Combine("Assets", "RPG_Maker_Tiles_Importer", "_rtp_auto_tiles");
            return tmp;
        }
    }
